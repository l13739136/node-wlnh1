...
const UUID = process.env.UUID || 'd1092db8-9827-4481-8bbb-27439a1c2a10'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'wlnh1';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'Hug';                    // 节点名称
const PORT = process.env.PORT || 7880;                     // http和ws服务端口
